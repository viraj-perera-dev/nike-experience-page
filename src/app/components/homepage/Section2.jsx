      ...
      style={{
        ...
        <div className="md:h-[70vh] h-[60vh] container mx-auto px-4 flex flex-col lg:flex-row lg:justify-center lg:items-center items-start justify-end relative z-10">
          ...
          <div className="max-w-xl gap-10 flex flex-col text-neutral-800">
            <h2 className="text-4xl md:text-5xl text-neutral-800 leading-tight">
              <em className="italic text-neutral-700 text-4xl md:text-5xl">Sneakers</em> go with everything. I can incorporate Nike sneakers
              <em className="italic text-neutral-700 text-4xl md:text-5xl"> into all my looks.</em><br />
            </h2>
